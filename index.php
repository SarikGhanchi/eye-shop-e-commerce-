...
<div class="container mt-4"> 
  ...
  <!-- Carousel -->
  <div id="eyewearCarousel" class="carousel slide mb-5" data-bs-ride="carousel">
    <div class="carousel-inner">
     <div class="carousel-item">
        <img src="" class="d-block w-100" alt="Eyewear Banner 1">
      </div>
      <div class="carousel-item">
        <img src="" class="d-block w-100" alt="Eyewear Banner 2">
      </div>
      <div class="carousel-item">
        <img src="" class="d-block w-100" alt="Eyewear Banner 3">
      </div>
    </div>
